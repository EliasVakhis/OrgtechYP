...
namespace OrgtechYP
{
    ...
    public partial class YPOrgtechBDEntities : DbContext
    {
        public YPOrgtechBDEntities()
            : base("name=YPOrgtechBDEntities")
        {
        }
        ...
        public virtual DbSet<ActiveRequests> ActiveRequests { get; set; }
